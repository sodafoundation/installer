...
#### For CSI Plugin
```
wget https://github.com/sodafoundation/nbp/releases/download/v1.0.0/opensds-sushi-v1.0.0-linux-amd64.tar.gz
tar zxvf opensds-sushi-v1.0.0-linux-amd64.tar.gz
