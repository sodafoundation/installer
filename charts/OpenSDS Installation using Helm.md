...
#### Download cli tool
```
wget https://github.com/opensds/opensds/releases/download/v0.10.2/opensds-hotpot-v0.10.2-linux-amd64.tar.gz
tar zxvf opensds-hotpot-v0.10.2-linux-amd64.tar.gz
cp opensds-hotpot-v0.10.2-linux-amd64/bin/* /usr/local/bin
...
#### For CSI Plugin
```
wget https://github.com/opensds/nbp/releases/download/v0.10.2/opensds-sushi-v0.10.2-linux-amd64.tar.gz
tar zxvf opensds-sushi-v0.10.2-linux-amd64.tar.gz
