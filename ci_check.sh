...
sed -i 's/^install_telemetry_tools: .*/install_telemetry_tools: '"true"'/g' ansible/group_vars/telemetry.yml
sed -i 's/^install_orchestration: .*/install_orchestration: '"false"'/g' ansible/group_vars/orchestration.yml
...
sed -i 's/^install_telemetry_tools: .*/install_telemetry_tools: '"false"'/g' ansible/group_vars/telemetry.yml
sed -i 's/^install_orchestration: .*/install_orchestration: '"false"'/g' ansible/group_vars/orchestration.yml
